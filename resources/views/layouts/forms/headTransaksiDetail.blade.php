...
<div class="card card-primary">
  <div class="card-header">
    <h2 style="font-weight: bold;">Head Transaksi Detail</h2>
  </div>
    ...
    <div class="card-body">
      ...
      <div class="form-group" >
        ...
        <div class="d-flex justify-content-between align-items-center row">
          ...
          <input type="UANG" class="form-control" placeholder="masukkan id transaksi"><br><br>
