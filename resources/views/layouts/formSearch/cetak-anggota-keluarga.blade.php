    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                    <form action="cetakangkel" id="frmLaporan" target="_blank" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <div class="form-group">
                                    <select name="nama_keluarga" id="nama_keluarga" class="form-select">
                                        <option value="">Pilih Nama Keluarga</option>
                                        @foreach ($cetakangkel as $d)
                                        <option value="{{ $d->no_registrasi }}">{{ $d->nama_keluarga }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
