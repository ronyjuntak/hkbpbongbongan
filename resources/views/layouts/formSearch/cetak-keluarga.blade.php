    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                    <form action="cetaklapkel" id="frmLaporan" target="_blank" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <div class="form-group">
                                    <select name="id_wijk" id="id_wijk" class="form-select">
                                        <option value="">Pilih Sektor</option>
                                        @foreach ($cetakkeluarga as $d)
                                        <option value="{{ $d->id_wijk }}">{{ $d->nama_wijk }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
